...
class VistaPersona(QWidget):
    ...
    def mostrar_persona(self, persona):
        ...
        if (self.persona!=None):
            ...
            self.texto_brazo.setText(str(self.persona["medidaCentimetrosBrazos"]))
            self.texto_pecho.setText(str(self.persona["medidaCentimetrosPecho"]))
            self.texto_cintura.setText(str(self.persona["medidaCentimetrosCintura"]))
            self.texto_pierna.setText(str(self.persona["medidaCentimetrosPiernas"]))
